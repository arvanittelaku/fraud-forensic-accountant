/** Shared internal link sets per SEO-ARCHITECTURE.md §3 */
...
export const PILLAR_PAGE_LINKS: InternalLink[] = [
  ...
  { href: "/case-types/corporate-internal-investigation", label: "Corporate internal investigation" },
  { href: "/case-types/money-laundering-proceedings", label: "Money laundering proceedings" },
  { href: "/glossary", label: "Fraud forensic glossary" },
